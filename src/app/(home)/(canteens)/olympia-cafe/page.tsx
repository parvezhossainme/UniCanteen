...
const OlympiaCafe = () => {
  ...
  useEffect(() => {
    async function fetchFoods() {
      const res = await fetch("/api/home/olympia-foods");
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Cafe Title */}
      <h1 className="text-4xl font-bold text-center mb-4 font-serif">OlympiaCafe</h1>
        ...
        {categories.map((cat) => (
          <button
            ...
            className={`px-6 py-2.5 rounded-full border-2 font-semibold transition-all duration-300 shadow-md ${
              activeCategory === cat
                ? "bg-linear-to-rrom-orange-500 to-amber-500 text-white border-orange-600 shadow-lg shadow-orange-500/50 scale-105"
